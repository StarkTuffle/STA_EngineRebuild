...
local function predicateCanRebuild(playerObj, part)
    ...
    if not ISVehicleMechanics:getWrench(playerObj) then return false end
...
local function attachTooltip(option, playerObj, part)
    ...
    if enginePartsCount < (Utils.getSandboxInt("EnginePartsRequired") * engineRepairLevel) then
        tooltip.description = tooltip.description .. " " .. ISVehicleMechanics.bhs .. getItemDisplayName("Base.EngineParts") .. " " .. enginePartsCount .. "/" .. (Utils.getSandboxInt("EnginePartsRequired") * engineRepairLevel) .. " <LINE>"
    else
        tooltip.description = tooltip.description .. " " .. ISVehicleMechanics.ghs .. getItemDisplayName("Base.EngineParts") .. " " .. enginePartsCount .. "/" .. (Utils.getSandboxInt("EnginePartsRequired") * engineRepairLevel) .. " <LINE>"
    end
end
